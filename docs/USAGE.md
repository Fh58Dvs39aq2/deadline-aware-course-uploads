...
The single thin client is the seam: add a method that calls another `/v1/...` route (e.g. one of storage.bucket.create, storage.object.presign, storage.object.list) and reuse it from your own code.
